...
$(document).ready(function () {
    ...
    $("#form-contact").submit(function (e) {
        ...
        if (v1.length < 3 || v2.length < 3 || v3.length < 3 || v4.length < 3 || v5.length < 3) {
...
function doToast(ttype, tmsg) {
    switch (ttype) {
        case 's':
            toastr.success(tmsg); break;
        case 'w':
            toastr.warning(tmsg); break;
        case 'i':
            toastr.info(tmsg); break;
        case 'e':
            toastr.error(tmsg); break;
        default:
            toastr.info(tmsg); break;
    }
}
